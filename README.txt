...
1) Η μοντελοποίηση:
    ...
    domain/cardinality της μεταβλητής.
        ...
        5) Ένα conflict set που περιέχει όχι μόνο τα επίπεδα των μεταβλητών 
           ...
           conflict set κάποιας μεταβλητής η οποία έπαθε domain wipeout κατα το forward check μίας μεταβλητής η οποία απέτυχε.
	   Επίσης περιέχει το conflict set της μεταβλητής που απέτυχε (και υπαναχώρησε στη συγκεκριμένη μεταβλητή)
           κατά την αναζήτηση λέξης να της ανατεθεί ώστε να μην προκαλείται domain wipeout σε γείτονα.
